export const PIZZAS = [
  {
    ...
    category: 'Pizza',
    name: 'Napolitana',
    description: 'Neapolitan-style; a thin round crust topped with a fresh tomato sauce, mozzarella, oregano, & stone deck oven baked. Ask about trying it upside down!',
