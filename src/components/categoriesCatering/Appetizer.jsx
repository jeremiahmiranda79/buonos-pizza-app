...
const Appetizer = () => {
  return (
    <Container id={CATEGORIES_CATERING[0].id}>
      <h1 
        className='Title'>{CATEGORIES_CATERING[0].name}
      </h1>
      <Image 
        src={CATEGORIES_CATERING[0].images} 
        fluid 
        alt={CATEGORIES_CATERING[0].name} 
      />

      <br /><br />

      <h2>
        {CATEGORIES_CATERING[0].choice}
      </h2>

      <h2>
        {CATEGORIES_CATERING[0].portion}
      </h2>
