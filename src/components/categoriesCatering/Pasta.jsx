...
const Pasta = () => {
  return (
    <Container id={CATEGORIES_CATERING[2].id}>
      <h1 
        className='Title'>{CATEGORIES_CATERING[2].name}
      </h1>
      <Image 
        src={CATEGORIES_CATERING[2].images} 
        fluid 
        alt={CATEGORIES_CATERING[2].name} 
      />
          ...
          <Col key={item.id}>
            <Card className='h-100'>
              ...
              <Card.Body>
                ...
                {item.addBrocoli ? <Card.Text>               
                  {item.addBrocoli} ${item.addBrocoliPrice}
                </Card.Text> : null}

                {item.addChicken ? <Card.Text>               
