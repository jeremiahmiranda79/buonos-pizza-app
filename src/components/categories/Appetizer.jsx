            ...
            <Card className='h-100'>
              ...
              <CardFooter className='text-muted'>
                {item.isWings && <div className='mt-auto'>
                  <Button style={{marginBottom: '7.5px', width: '100%'}} variant="primary" onClick={() => setModalShow(true)}>See wing sauce choices</Button><br />
                </div>}

                <MyVerticallyCenteredModal show={modalShow}onHide={() => setModalShow(false)}/>
                  
                {item.isWings && <div className='mt-auto'>
                  <Button style={{marginBottom: '7.5px', width: '100%'}} variant="primary" onClick={() => setModalShow2(true)}>See dressing choices</Button><br />
                </div>}
