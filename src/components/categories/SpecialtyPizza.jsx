...
const SpecialtyPizza = () => {
  ...
  return (
    <Container id={PRODUCT_CATEGORIES[1].id} style={{scrollMarginTop: '150px'}}>
      ...
      <Image style={{marginBottom: '10px'}} src="/images/categories/pizza-cat.jpg" fluid alt={PRODUCT_CATEGORIES[1].name}/>
        ...
        {SPECIALTY_PIZZA.map((item) => (
          ...
          <Card className='h-100'>
            ...
            <CardFooter className='text-muted'>
              ...
              {/* <a href='https://online.skytab.com/ba1259fa275c3fa135327dc3dba6bc5f/order-settings'><Button variant="primary" style={{width: '100%'}}>Start An Online Pickup Order <i class="fa-solid fa-cart-shopping"></i></Button>
              </a> */}
