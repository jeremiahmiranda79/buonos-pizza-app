...
//       <Image style={{marginBottom: '10px'}} src="/images/categories/entree.webp" fluid alt={PRODUCT_CATEGORIES[10].name}/>
...
//                 {item.isPasta && <div className=''>
//                   <Button style={{marginBottom: '7.5px', width:'100%'}} variant="primary" onClick={() => setModalShow(true)}>See pasta choices</Button>
//                 </div>}

//                 <MyVerticallyCenteredModal show={modalShow} onHide={() => setModalShow(false)}/>

//                 <div className=''>
//                   <Button style={{marginBottom: '7.5px', width:'100%'}} variant="primary" onClick={() => setModalShow2(true)}>See salad options</Button>
//                 </div>
