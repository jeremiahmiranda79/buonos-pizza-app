      ...
      <Modal.Body>
        ...
        <ul>
          {CALZONE_FILLINGS.map((filling) => (
            <li key={filling.id}>{filling.name} - Small: ${filling.priceSmall.toFixed(2)} Large: ${filling.priceLarge.toFixed(2)}
            </li>))
          }
        </ul>
          ...
          <Col key={item.id}>
            ...
            <Card className='h-100'>
              ...
              <CardFooter className='text-muted'>
                <Button style={{marginBottom: '7.5px', width: '100%'}} variant="primary" onClick={() => setModalShow(true)}>See filling choices</Button>
